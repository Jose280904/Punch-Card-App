...
const adminEmails = [
  ...
  "dmeza@pcpsystems.com",
  "miranda@pcpsystems.com"
];
...
document.getElementById("lunchOutBtn").addEventListener("click", async () => {
  await savePunch("Start Lunch");
});

document.getElementById("lunchInBtn").addEventListener("click", async () => {
